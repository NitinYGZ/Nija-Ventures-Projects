            ...
            {caseStudies.map((study, idx) => (
              ...
              >
                <div className="flex items-start gap-6 mb-6">
                  ...
                  <div>
                    <div className="text-sm text-emerald-600 mb-2">{study.industry}</div>
                    <h3 className="text-2xl lg:text-3xl text-slate-900">{study.title}</h3>
                  </div>
                </div>

                <div className="grid lg:grid-cols-3 gap-8">
                  <div>
                    <div className="text-xs uppercase tracking-wide text-slate-500 mb-2">Challenge</div>
                    <p className="text-slate-700 leading-relaxed">{study.challenge}</p>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wide text-slate-500 mb-2">Solution</div>
                    <p className="text-slate-700 leading-relaxed">{study.solution}</p>
                  </div>
                  <div>
                    <div className="text-xs uppercase tracking-wide text-slate-500 mb-2">Results</div>
