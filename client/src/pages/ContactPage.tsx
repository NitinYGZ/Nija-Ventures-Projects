              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="Solutions Architect">Tokenisation solution</option>
                    <option value="Overview">Supply chain solution</option>
                    <option value="Security Brief">Identity management</option>
